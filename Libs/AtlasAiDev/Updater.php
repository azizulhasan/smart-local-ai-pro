...
/**
 * Class Updater
 * @package AtlasAiDev\AppService\Pro
 */
class Updater {
	...
	/**
	 * AtlasAiDev\AppService\Pro\License
	 *
	 * @var License
	 */
	protected $license;
	...
	public function __construct( Client $client, License $license ) {
		...
		$this->cache_key = 'AtlasAiDev_' . md5( $this->client->getSlug() ) . '_version_info';
	}
	...
	/**
	 * Get plugin info from AtlasAiDev
	 * @return bool|array
	 */
	private function get_information() {
		...
		if ( isset( $response['success'] ) && $response['success'] ) {
			 ...
			 * @param array $data
			 */
			$data = apply_filters( 'AtlasAiDev_' . $this->client->getSlug() . '_plugin_api_info', $data );
