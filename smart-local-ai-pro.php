...
if ( ! function_exists( 'atlas_ai_fs' ) ) {
	 ...
	 */
	atlas_ai_fs()->add_action( 'after_uninstall', 'atlas_ai_pro_uninstall_cleanup' );
}

/**
 * Clean up Pro-specific data on uninstall.
 */
function atlas_ai_pro_uninstall_cleanup() {
